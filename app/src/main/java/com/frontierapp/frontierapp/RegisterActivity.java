...
public class RegisterActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user !=null){
                    ...
                    Toast.makeText(RegisterActivity.this, "Successfullly signed in", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(RegisterActivity.this, "Successfullly sign out", Toast.LENGTH_LONG).show();
                }
            }
        };
    ...
    public void addUserToFirestore(String uid){
        ...
        firebaseFireStore.collection("UserInformation").document("Users").collection("User").document(uid)
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(RegisterActivity.this, "You account has been created."
                        , Toast.LENGTH_LONG)
                        .show();
            }
        })
   ...
   private void addUserToFirestore() {
        ...
        if (!TextUtils.isEmpty(emailText) && !TextUtils.isEmpty(passwordText) && !TextUtils.isEmpty(conPasswordText) &&
            ...
            Toast.makeText(RegisterActivity.this, "Adding User", Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Intent welcome = new Intent(RegisterActivity.this, SkillsInformationActivity.class);
