...
public class FollowerFragment extends Fragment {
    ...
    private FollowerViewModel connectionsViewModel;
    private final Query query = collectionReference.whereEqualTo(FirestoreConstants.FOLLOWER, true);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        connectionsViewModel = ViewModelProviders.of(getActivity()).get(FollowerViewModel.class);
        getConnections();
